...
import 'package:taxi_app/simple_map.dart';
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    const Color(0xFFF67F00).withOpacity(0.1),
                    Colors.white,
                  ],
                ),
              ),
              child: Column(
                children: [
                  CircleAvatar(
                    radius: 60,
                    backgroundColor:const Color(0xFFF67F00).withOpacity(0.1),
                    child: Icon(
                      Icons.check_circle,
                      size: 80,
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(10),
                                borderSide: BorderSide(color: const Color(0xFFF67F00)),
                              ),
                            ),
                          ),
                        ],
